<?php if(!class_exists('Rain\Tpl')){exit;}?>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/res/admin/assetsimages/favicon/favicon-32x32.png">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <!-- Início: VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/vendors/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/vendors/animate-css/animate.css">
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/vendors/chartist-js/chartist.min.css">
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/vendors/chartist-js/chartist-plugin-tooltip.css">
    <!-- Fim: VENDOR CSS-->
    <!-- Início: Estilos Em CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/css/pages/dashboard-modern.css">
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/css/pages/intro.css">
    <!-- Fim: Estilos Em CSS-->
    <!-- Início: Customização CSS-->
    <link rel="stylesheet" type="text/css" href="/res/admin/assets/css/custom/custom.css">
    <!-- Fim: Customização CSS-->
  </head>
  <!-- Fim: Head-->
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
        ...
        <nav class="navbar-main navbar-color nav-collapsible sideNav-lock navbar-dark red no-shadow">
          <div class="nav-wrapper">
            ...
            <ul class="dropdown-content" id="profile-dropdown">
              <li><a class="grey-text text-darken-1" href="/admin/perfil"><i class="material-icons">person_outline</i> Perfil</a></li>
              <li><a class="grey-text text-darken-1" href="#"><i class="material-icons">chat_bubble_outline</i> Chat</a></li>
              <li><a class="grey-text text-darken-1" href="/admin/ajuda"><i class="material-icons">help_outline</i> Ajuda</a></li>
              <li class="divider"></li>
              <li><a class="grey-text text-darken-1" href="/admin/bloqueado"><i class="material-icons">lock_outline</i> Bloquear</a></li>
      ...
      <div class="brand-sidebar">
        <h1 class="logo-wrapper">
          <a class="brand-logo darken-1" href="/admin">
            <span class="logo-text hide-on-med-and-down">Agência Seguros</span>
          </a>
        </h1>
      </div>
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        <li class="active bold">
          <a class="waves-effect waves-cyan active red" href="/admin">
    ...
    <div id="main">
      <div class="row">
        <div class="content-wrapper-before" style="background-color: #ffffff !important "></div>
        <div class="col s12">
          <div class="container">
                     ...
                     <div class="card gradient-45deg-light-blue-cyan gradient-shadow min-height-100 white-text animate fadeLeft">
                        <div class="padding-4">
                           <div class="col s7 m7">
                              ...
                              <p>Propostas/Apólices</p>
                           </div>
                           <div class="col s5 m5 right-align">
                              <h5 class="mb-0 white-text">10</h5>
                              <p class="no-margin">Hoje</p>
                              <p>6,00,00</p>
                           </div>
                        </div>
                     </div>
...
>-->
    ...
    <script src="/res/admin/assets/vendors/chartjs/chart.min.js" type="text/javascript"></script>
    <script src="/res/admin/assets/vendors/chartist-js/chartist.min.js" type="text/javascript"></script>
    <script src="/res/admin/assets/vendors/chartist-js/chartist-plugin-tooltip.js" type="text/javascript"></script>
    <script src="/res/admin/assets/vendors/chartist-js/chartist-plugin-fill-donut.min.js" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME  JS-->
    ...
    <!-- END THEME  JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="/res/admin/assets/js/scripts/dashboard-modern.js" type="text/javascript"></script>
    <script src="/res/admin/assets/js/scripts/intro.js" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
  </body>
</html>