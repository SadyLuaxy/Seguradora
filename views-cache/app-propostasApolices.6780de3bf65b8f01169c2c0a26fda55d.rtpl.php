<?php if(!class_exists('Rain\Tpl')){exit;}?>
    <title> Propóstas e Apólices | Agência de Seguros Admin</title>
  ...
  <div class="sidebar">
    <div class="sidebar-content">
      <div class="sidebar-header">
        <div class="sidebar-details col s12" style="width:100em;">
          ...
          <div class="sidebar-header">
            <div class="sidebar-details col s6 16 x13">
               <div class="card animate" style="padding-top: 2px;padding-bottom: 50px">
                  <h5 style="border-bottom:1px solid darkgrey;padding-left: 10px;padding-bottom: 2px">Propostas</h5>
                  <div class="col s6 m6">
                     <p class="text-muted" style="color: black;">VIGENTES</p>
                  ...
                  <div class="col s6 m6" style="border: none;border-left: 1px solid rgb(221, 221, 221);height: 7vh;">
                     <p class="no-margin text-muted" style="color: black;">PENDENTES DE EMISSÃO</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
               </div>
            </div>
            <div class="sidebar-details col s6 16 x13">
               <div class="card animate" style="padding-top: 2px;padding-bottom: 50px">
                  <h5 style="border-bottom:1px solid darkgrey;padding-left: 10px;padding-bottom: 2px">Apólices</h5>
                  <div class="col s6 m6">
                     <p class="text-muted" style="color: black;">VIGENTES</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
                  <div class="col s6 m6" style="border: none;border-left: 1px solid rgb(221, 221, 221);height: 7vh;">
                     <p class="no-margin text-muted" style="color: black;">PENDES DE RENOVAÇÃO</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
               </div>
            </div>
                ...
                <div class="col s12">
                    <table id="page-length-option" class="display">
                        ...
                        <tr>
                            ...
                            <td>s</td>
                            <td>
                                <a class="btn-floating btn-small btn-small waves-effect waves-light orange modal-trigger btn tooltipped" data-position="top" data-tooltip="Editar" href="/admin/propostasApolices/mostrar"><i class="material-icons">edit</i></a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
