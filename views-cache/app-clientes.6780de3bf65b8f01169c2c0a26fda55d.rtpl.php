        ...
        <div class="col s12">
          <div class="container">
              <div style="bottom: 54px; right: 19px;" class="fixed-action-btn direction-top">
                <a class="btn-floating btn-large primary-text gradient-shadow modal-trigger" href="/admin/clientes/novo">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a class="btn-floating btn-small btn-small waves-effect waves-light orange modal-trigger btn tooltipped" data-position="top" data-tooltip="Editar" href="/admin/clientes/editar/<?php echo htmlspecialchars( $value1["id_cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="material-icons">edit</i></a>
                      <a class="btn-floating btn-small btn-small waves-effect waves-light red modal-trigger btn tooltipped" onclick="return confirm('Deseja realmente excluir esse cliente?')" data-position="top" data-tooltip="Excluir" href="/admin/clientes/deletar/<?php echo htmlspecialchars( $value1["id_cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><i class="material-icons">delete</i></a>
                    </td>
                  </tr>

                  <!-- Modal De Informações Adicionais -->
                  <div id="outrasinfo<?php echo htmlspecialchars( $value1["id_cliente"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="modal border-radius-6" style="width:45% !important;">
