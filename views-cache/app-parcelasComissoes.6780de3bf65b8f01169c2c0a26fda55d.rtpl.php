        ...
        <div class="col s12">
          <div class="container">
              <div style="bottom: 54px; right: 19px;" class="fixed-action-btn direction-top">
                <a class="btn-floating btn-large primary-text gradient-shadow modal-trigger" href="/admin/parcelas/novo/mostrar">
        ...
        <div class="col s12 m12">
            <div class="card subscriber-list-card animate fadeRight">
                <div class="card-content pb-1">
                    <h4 class="card-title mb-0">Parcelas<i class="material-icons float-right">more_vert</i></h4>
                </div>
                <table class="subscription-table responsive-table highlight centered">
                    ...
                    <tr>
                        ...
                        <th>Comissão já recebida?</th>
                        <th>Valor recebido</th>
                        <th>Diferença</th>
                        <th>Recebido em</th>
                        <th>Data de lançamento</th>
                        <th>Tipo
                        <th>Segurado já pagou?</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        ...
                        <td>10 (%)</td>
                        <td>50,00 (Kz)</td>
                        <td><span class="badge pink lighten-5 pink-text text-accent-2">Não</span></td>
                        <td>40,00 (Kz)</td>
                        <td>10,00 (Kz)</td>
                        <td>13/09/2019</td>
                        <td>Seguro</td>
                        ...
                        <td class="center-align">
                            <a href="/admin/parcelas/editar/mostrar"><i class="material-icons pink-text">edit</i></a>
                            <a href="/admin/parcelas/apagar/mostrar"><i class="material-icons pink-text">delete</i></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
