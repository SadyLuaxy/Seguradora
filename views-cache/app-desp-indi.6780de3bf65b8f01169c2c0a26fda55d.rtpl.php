  ...
  <body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 2-columns  " data-open="click" data-menu="vertical-modern-menu" data-col="2-columns">
    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
        ...
        <li class="active bold"><a class="waves-effect waves-cyan active red" href="app-despesas.html"><i class="material-icons">money_off</i><span class="menu-title" data-i18n="">Despesas</span></a>
        </li>
    ...
    <div class="sidebar-content">
      <div class="sidebar-header">
        <div class="sidebar-details">
          <h6 class="m-0 sidebar-title"><i class="material-icons app-header-icon text-top">person</i> Despesas de: Sady Luaxy Luis Eduardo
          </h6>
          <h6 class="m-0 sidebar-title"><i class="material-icons app-header-icon text-top">info</i> NIF:
            8976624623
          </h6>
          <div class="mt-5">
