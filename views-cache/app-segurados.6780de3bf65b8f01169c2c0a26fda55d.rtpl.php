        ...
        <div class="col s12">
          <div class="container">
              <div style="bottom: 54px; right: 19px;" class="fixed-action-btn direction-top">
                <a class="btn-floating btn-large primary-text gradient-shadow modal-trigger" href="#cadastrarSegurado">
      ...
      <div class="sidebar-header">
        ...
        <div class="nav-wrapper" style="padding-top: 20px;">
          <div class="col s12">
            ...
            <a href="/admin/segurados" class="breadcrumb text-muted" style="font-size: 14px !important;">Segurados</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="sidebar-right sidebar-fixed center-align">
      <div class="sidebar" style="width: auto !important">
        <div class="sidebar-content">
          <div class="sidebar-header">
            <div class="sidebar-details col s6 16 x13">
               <div class="card animate" style="padding-top: 2px;padding-bottom: 50px">
                  <h5 style="border-bottom:1px solid darkgrey;padding-left: 10px;padding-bottom: 2px">Segurados</h5>
                  <div class="col s6 m6">
                     <p class="text-muted" style="color: black;">PESSOAS FÍSICAS</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
                  <div class="col s6 m6" style="border: none;border-left: 1px solid rgb(221, 221, 221);height: 7vh;">
                     <p class="no-margin text-muted" style="color: black;">PESSOAS JURÍDICAS</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
               </div>
            </div>
            <div class="sidebar-details col s6 16 x13">
               <div class="card animate" style="padding-top: 2px;padding-bottom: 50px">
                  <h5 style="border-bottom:1px solid darkgrey;padding-left: 10px;padding-bottom: 2px">Aniversariantes</h5>
                  <div class="col s6 m6">
                     <p class="text-muted" style="color: black;">HOJE</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
                  <div class="col s6 m6" style="border: none;border-left: 1px solid rgb(221, 221, 221);height: 7vh;">
                     <p class="no-margin text-muted" style="color: black;">DO MÊS</p>
                     <h5 style="text-align: center;color:#5fbf5f">0</h5>
                  </div>
               </div>
            </div>
              ...
              <table id="page-length-option" class="display">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>s</td>
                    <td>
                      <a class="btn-floating btn-small btn-small waves-effect waves-light orange modal-trigger btn tooltipped" data-position="top" data-tooltip="Editar" href="/admin/segurados/mostrar"><i class="material-icons">edit</i></a>
                    </td>
                  </tr>

                  <!-- Modal De Informações Adicionais -->
                  <div id="cadastrarSegurado" class="modal border-radius-6" style="width:30% !important;">
                    <div class="modal-content ">
                      <h6 class="mt-0">Novo segurado</h6>
                      <hr>
                      <div class="row">
                          <form class="formValidate0" id="formValidate0" method="post" action="/admin/segurados/novo">
                            <div class="row">
                              <div class="input-field col s12">
                                <label for="uname0">Nome ou razão social*</label>
                                <input class="validate" required aria-required="true" id="nome0" name="nome_cliente" type="text" id="uname0">
                              </div>
                              <div class="input-field col s12 ">
                                  <label for="nif">NIF</label>
                                  <input class="validate" required aria-required="true" id="nif" name="nif" type="text">
                              </div>
                              <div class="input-field col s12">
                                  <label for="telefone">Telefone</label>
                                  <input class="validate" required aria-required="true" id="telefone" name="telefone" type="number">
                              </div>
                              <div class="input-field col s12">
                                  <label for="email0">Email</label>
                                  <input class="validate" required aria-required="true" id="email0" name="email" type="email">
                              </div>
                            </div>
                            <div class="modal-footer">
                                <a href="#!" class="modal-close waves-effect waves-green btn-flat">Cancelar</a>
                                <input type="submit" class="waves-green btn-flat" value="Adicionar">
                            </div>
                          </form>
                      </div>
                    </div>
